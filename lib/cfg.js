...
//  ; IMMEDIATE
    ...
    def('else', function () {
        ...
        this.cfs.push(oldlimbs);

        this.pos = wrap.body.body;
        this.label++;
        // console.log(jsof.s(this.pos, {ansi: true}));
        // var pos = [];
...
/*
    ...
    WHILE               if(!dpop) { break L3; }

    WHILE               if(!dpop) { break L4; }
...
//  ; IMMEDIATE
    ...
    def('while', function () {
        ...
        // this.cfs.push(this.pos[this.pos.length - 1]);
        this.label++;
    }, cxt, { immediate: true });
...
//  ; IMMEDIATE
    def('repeat', function () {
        ...
        last.label.name = 'L' + this.labels.pop();
    }, cxt, { immediate: true });
